...
EKIDEN_KM_BINARY=${EKIDEN_KM_BINARY:-"${EKIDEN_ROOT_PATH}/target/x86_64-fortanix-unknown-sgx/debug/ekiden-keymanager-runtime.sgxs"}
EKIDEN_RUNTIME_BINARY=${EKIDEN_RUNTIME_BINARY:-"./target/x86_64-fortanix-unknown-sgx/debug/runtime-ethereum.sgxs"}
