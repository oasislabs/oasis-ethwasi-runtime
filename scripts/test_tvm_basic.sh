...
run_test() {
    ...
    pushd ${WORKDIR}/tests/contracts/tvm_basic_contract > /dev/null
    make clean
    make
    popd > /dev/null
    ...
    OUTPUT="$(./deploy_contract.js --gas-limit 0xf42400 --gas-price 0x3b9aca00 ${WORKDIR}/target/tvm_basic_contract.wasm | tail -1)"
