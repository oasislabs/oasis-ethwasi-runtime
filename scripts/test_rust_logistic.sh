...
run_test() {
    ...
    OUTPUT="$(./deploy_contract.js --gas-limit 0xf42400 --gas-price 0x3b9aca00 ${WORKDIR}/tests/contracts/rust-logistic-contract/target/rust_logistic_contract.wasm | tail -1)"
